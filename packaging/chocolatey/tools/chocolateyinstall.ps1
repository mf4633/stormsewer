...
$packageArgs = @{
    ...
    fileType       = 'exe'
    url64bit       = 'https://github.com/mf4633/stormsewer/releases/download/v0.9.5/StormSewer-0.9.5-setup.exe'
    checksum64     = '6834339cf9185536a655ae120cb521c847117257fb7f4cc8c84162524563dbfb'
